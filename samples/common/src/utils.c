...
void utils_log_astarte_value(astarte_value_t value)
{
    ...
    switch (astarte_value_get_type(value)) {
        case ASTARTE_MAPPING_TYPE_BINARYBLOB:
            void *blob = NULL;
            size_t blob_len = 0;
            (void) astarte_value_to_binaryblob(value, &blob, &blob_len);
        ...
        case ASTARTE_MAPPING_TYPE_BINARYBLOBARRAY:
            ...
            size_t *sizes = NULL;
            size_t count = 0;
            (void) astarte_value_to_binaryblob_array(value, &blobs, &sizes, &count);
        ...
        case ASTARTE_MAPPING_TYPE_BOOLEAN:
            bool boolean = false;
            (void) astarte_value_to_boolean(value, &boolean);
        ...
        case ASTARTE_MAPPING_TYPE_BOOLEANARRAY:
            ...
            bool *bools = NULL;
            size_t bools_len = 0;
            (void) astarte_value_to_boolean_array(value, &bools, &bools_len);
        ...
        case ASTARTE_MAPPING_TYPE_DATETIME:
            ...
            (void) astarte_value_to_datetime(value, &datetime);
        ...
        case ASTARTE_MAPPING_TYPE_DATETIMEARRAY:
            ...
            (void) astarte_value_to_datetime_array(value, &datetimes, &datetimes_len);
        ...
        case ASTARTE_MAPPING_TYPE_DOUBLE:
            double dbl = false;
            (void) astarte_value_to_double(value, &dbl);
        ...
        case ASTARTE_MAPPING_TYPE_DOUBLEARRAY:
            ...
            (void) astarte_value_to_double_array(value, &doubles, &doubles_len);
        ...
        case ASTARTE_MAPPING_TYPE_INTEGER:
            ...
            (void) astarte_value_to_integer(value, &integer);
        ...
        case ASTARTE_MAPPING_TYPE_INTEGERARRAY:
            ...
            (void) astarte_value_to_integer_array(value, &integers, &integers_len);
        ...
        case ASTARTE_MAPPING_TYPE_LONGINTEGER:
            ...
            (void) astarte_value_to_longinteger(value, &longinteger);
        ...
        case ASTARTE_MAPPING_TYPE_LONGINTEGERARRAY:
            ...
            (void) astarte_value_to_longinteger_array(value, &longintegers, &longintegers_len);
        ...
        case ASTARTE_MAPPING_TYPE_STRING:
            ...
            (void) astarte_value_to_string(value, &string);
        ...
        case ASTARTE_MAPPING_TYPE_STRINGARRAY:
            ...
            (void) astarte_value_to_string_array(value, &strings, &strings_len);
