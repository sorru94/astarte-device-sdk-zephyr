 ...
 * The only difference is that this module uses the Astarte heap for dynamic allocation.
 * For more info see: https://docs.zephyrproject.org/apidoc/latest/group__bsd__sockets.html
 *
 */
int astarte_getaddrinfo(const char *host, const char *service, const struct zsock_addrinfo *hints,
 ...
 *
 */
void astarte_freeaddrinfo(struct zsock_addrinfo *ai);
// NOLINTEND
