...
static const astarte_res_msg_t astarte_res_msg_table[] = {
    ...
    RES_TBL_IT(ASTARTE_RESULT_KEY_VALUE_FULL),
    RES_TBL_IT(ASTARTE_RESULT_KEY_VALUE_INCOMPATIBLE_VERSION),
    RES_TBL_IT(ASTARTE_RESULT_KEY_VALUE_RECOVERY_FAILED),
    ...
    RES_TBL_IT(ASTARTE_RESULT_MISMATCH),
