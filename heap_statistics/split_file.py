...
def split_file_by_transmission(input_file, out_folder, out_prefix):
    ...
    with open(input_file, 'r') as f:
        ...
        closing_indices = [i for i, line in enumerate(lines) if 'Astarte device sample finished' in line]
        ...
        if len(closing_indices) != 1:
            raise ValueError("Input file should contain exactly 1 line with 'Astarte device sample finished'.")
